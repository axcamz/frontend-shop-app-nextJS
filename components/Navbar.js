                    ...
                    <div className="flex items-center lg:hidden">
                        <div className="flex items-center">
                            <div className="flex group items-center">
                                ...
                                <input className="ml-1 h-10 w-0 group-hover:w-36 group-hover:px-3 font-poppins outline-none rounded focus:ring-2 ring-yellow-500 focus:w-36 focus:px-3 transition-all" type="text"/>
                            </div>
                        ...
                        <div className={`flex flex-col transition-all ml-5 h-5 ${toggle ? 'justify-between':'justify-evenly'}`} onClick={() => setToggle(!toggle)}>
