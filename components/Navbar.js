    ...
    return (
        <nav className="bg-primary">
            <div className="lg:container lg:mx-auto flex lg:flex-row lg:px-0 px-3 flex-col py-4">
                    ...
                    <div className="flex items-center lg:hidden">
                        <div className="flex">
                            ...
                            <div className="relative ml-3">
                                ...
                                <div className="bg-yellow-500 px-1 rounded-full absolute -top-2 -right-2">
                                    20
                                </div>
                            </div>
                        </div>
                ...
                <div className={`lg:flex-row lg:flex flex-col lg:items-center w-full lg:justify-between font-poppins mt-3 ${toggle ? 'flex':'hidden'}`}>
                    <div className="flex lg:flex-row flex-col lg:justify-evenly justify-between lg:w-1/3 h-28 lg:h-auto lg:mb-0 mb-5">
                        <div><a href="#">Home</a></div>
                        <div className="flex group items-center justify-between relative">
                            ...
                            <div className="z-10 bg-white shadow p-3 absolute top-1 rounded invisible group-hover:visible flex transform translate-y-0 opacity-0 group-hover:opacity-100 group-hover:translate-y-6 transition-all flex-col w-full">
                                <a className="py-1" href="#">Profile</a>
                                <a className="py-1" href="#">Settings</a>
                                <a className="py-1" href="#">Settings</a>
                                <a className="py-1" href="#">Settings</a>
                                <a className="py-1" href="#">Settings</a>
                    ...
                    <div className="flex justify-between">
                        ...
                        <div className="flex items-center lg:ml-5 group relative">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 text-semiblack" fill="none" viewBox="0 0 24 24" stroke="currentColor">
